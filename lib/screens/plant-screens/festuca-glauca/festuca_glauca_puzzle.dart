...
class FestucaGlaucaPuzzleScreen extends StatefulWidget {
  const FestucaGlaucaPuzzleScreen({super.key});

  @override
  State<FestucaGlaucaPuzzleScreen> createState() => _FestucaGlaucaPuzzleScreenState();
}

class _FestucaGlaucaPuzzleScreenState extends State<FestucaGlaucaPuzzleScreen> {
  ...
  late Timer _timer;
  int _elapsedTime = 0;
  final String _imagePath = 'images/levels/level2-plant.jpg';
